...
#[AsMessageHandler]
final class UpdateInvoiceItemQuantityCommandHandler
{
    ...
    public function __invoke(UpdateInvoiceItemQuantityCommand $command): void
    {
        ...
        $invoice->updateItemQuantity($command->itemIndex, $command->quantity);
